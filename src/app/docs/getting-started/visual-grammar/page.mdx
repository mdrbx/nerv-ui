...
- Prefer <Link href="/docs/components/card">`<Card variant="video" rounded />`</Link>, <Link href="/docs/components/pilot-card">Pilot Card</Link>, <Link href="/docs/components/pattern-alert">Pattern Alert</Link>, and <Link href="/docs/components/status-stamp">Status Stamp</Link>.
