...
export interface EvaBreadcrumbItem {
  label: string;
  href?: string;
  onClick?: () => void;
}

export interface EvaBreadcrumbProps
  extends Omit<HTMLAttributes<HTMLElement>, "color"> {
  /** Breadcrumb items */
  items: EvaBreadcrumbItem[];
...
export const EvaBreadcrumb = forwardRef<HTMLElement, EvaBreadcrumbProps>(
  function EvaBreadcrumb(
