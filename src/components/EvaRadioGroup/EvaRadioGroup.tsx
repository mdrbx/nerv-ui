...
export interface EvaRadioOption {
  value: string;
  label: string;
  disabled?: boolean;
}

export interface EvaRadioGroupProps
  extends Omit<HTMLAttributes<HTMLDivElement>, "onChange" | "color"> {
  /** Radio options */
  options: EvaRadioOption[];
...
export const EvaRadioGroup = forwardRef<HTMLDivElement, EvaRadioGroupProps>(
  function EvaRadioGroup(
    {
      options,
      value,
      onChange,
